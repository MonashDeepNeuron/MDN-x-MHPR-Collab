...
class Train():
    ...
    def train(self,n_games):
        ...
        # register_env()
        env = gym.make("RocketSim-v0", reward_function=RewardFunction(RewardFunctions.KeepUpright))
        ...
        for i in range(n_games):
            ...
            peak_alt = env.unwrapped.get_alt()
            ...
            while not done:
                ...
                peak_alt = max(peak_alt, env.unwrapped.get_alt())
            ...
            altitude = env.unwrapped.get_alt()
            
            wandb.log({"eps_reward": score,"eps_scaled_score": score / time_steps, "alititude": altitude, "peak_alt": peak_alt, "eps_length": time_steps})
