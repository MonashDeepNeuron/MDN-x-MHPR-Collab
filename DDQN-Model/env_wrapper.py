...
class RocketSim(gym.Env):
    def __init__(self, reward_function: RewardFunction):
        ...
        self.observation_space = self.observation_spaces['euler_angles']
    ...
    def has_reached_termination(self):
        ...
        is_below_ground = obs["altitude"].item() < -5 # Give it some room
    ...
    def reset(self, seed=None, options=None):
        ...
        obs = self._get_obs()
        obs = obs['euler_angles']
        #print('state reset: ',obs)
        return obs, {}
